...
from services.domain import file_mapping_service, raw_data_loader, conversion_service
...
def apply_global_metadata(
    ...
    # Add global metadata
    ds.attrs['site_name'] = runtime_cfg.site_name
...
def build_site_dataset(runtime_cfg):
    ...
    validate_raw_data_integrity(file_map)

    # Get loader adapter for system type
    adapter = raw_data_loader.get_adapter(runtime_cfg.system_type)
