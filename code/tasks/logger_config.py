...
#         log_path: str, max_bytes: int=5_000_000, backup_count: int=5, 
#         level: int=logging.DEBUG) -> None:
#     """
#     Configure a JSON logger with rotating file and console output.

#     Args:
#         log_path: Path to the log file.
#         max_bytes: Maximum size of a single log file in bytes (default 5 MB).
