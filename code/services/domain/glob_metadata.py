...
from services.foundational import dereference, config_loader
...
# Set consts
CONFIGS = config_loader.load_config_file_from_name('sparql_queries')
...
def get_metadata_manager(*, source: str, **kwargs) -> GlobalMetadataManager:
    ...
    if source == "rdf":
        ...
        df = pd.DataFrame.from_dict(
            data=config_loader.load_config_file_from_name('site_metadata'),
            orient='index'
            )
        # file = (
